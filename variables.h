...
namespace Kratos
{
    ...
    // for droplet application example
    
    
    // 1. for PFEM fluids application:
    
    

    
    KRATOS_DEFINE_VARIABLE( double, IS_BIMAT )
